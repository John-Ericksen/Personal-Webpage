const ExperienceData = [
  ...
  },
  {
    ...
    text: "Interned at Amazon, AWS branch. Designed and coded web pages along with improving accessibility features for blind and visually impaired users, along with developed a link checking tool, ensuring the health and accuracy of links on AWS pages.",
  },
];
